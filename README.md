...
Today, the repository is a freestanding kernel seed. Long-term, OS/mosis is intended to grow into a real Unix-derivative system, with FreeBSD lineage as the intended anchor, rather than stopping at a merely "Unix-like" aesthetic.
...
Read the expanded [Manifesto](manifesto.md) for the full oath, the tone, and the promises we will not break. Contributor and automation guidance lives in [AGENTS.md](AGENTS.md). Longer-horizon sequencing lives in [docs/ROADMAP.md](docs/ROADMAP.md).

## Directory overview
- `AGENTS.md` — Repo guidance for human and automated contributors; preserves project intent, voice, and documentation truthfulness.
...
- 🎯 Strategic direction: keep kernel and userland co-designed while documenting the path from freestanding seed to Unix-derivative system with FreeBSD lineage as the intended anchor.
